...
# Ваш file_id стикера
STICKER_ID = "CAACAgIAAxkBAAEM8qhnvu9jRYqxAcl08cFyOMPeHeyzFQACmmcAAi92kEm-U0zxFr9FzzYE"
...
async def send_welcome(message: Message):
    welcome_text = (
        ...
        "🚀 Начни своё путешествие прямо сейчас!"
    )
    ...
    try:
        ...
        logging.info("Стикер успешно отправлен.")
    except Exception as e:
        logging.error(f"Ошибка при отправке стикера: {e}")
        await message.reply("Не удалось отправить стикер. Попробуйте позже.")
